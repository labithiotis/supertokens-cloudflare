...
const recipe_2 = __importDefault(require("./recipe/usermetadata/recipe"));
const recipe_3 = __importDefault(require("./recipe/multifactorauth/recipe"));
const recipe_4 = __importDefault(require("./recipe/totp/recipe"));
class SuperTokens {
    constructor(config) {
        var _a, _b, _c, _d;
        ...
        this.recipeModules = config.recipeList.map((func) => {
            ...
            else if (recipeModule.getRecipeId() === recipe_2.default.RECIPE_ID) {
                userMetadataFound = true;
            }
            else if (recipeModule.getRecipeId() === recipe_3.default.RECIPE_ID) {
                multiFactorAuthFound = true;
            }
            else if (recipeModule.getRecipeId() === recipe_4.default.RECIPE_ID) {
                totpFound = true;
            }
            return recipeModule;
        });
        ...
        if (!userMetadataFound) {
            ...
            this.recipeModules.push(recipe_2.default.init()(this.appInfo, this.isInServerlessEnv));
        }
        ...
        this.telemetryEnabled = config.telemetry === undefined ? node_process_1.env.TEST_MODE !== "testing" : config.telemetry;
    }
    static init(config) {
    ...
    static reset() {
        if (node_process_1.env.TEST_MODE !== "testing") {
