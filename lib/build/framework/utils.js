...
function inflate(stream, options) {
    ...
    switch (encoding) {
        ...
        case "deflate":
            ...
            decompression = zlib_1.default.createUnzip(options);
            break;
        case "br":
            if (zlib_1.default.createBrotliDecompress) {
                decompression = zlib_1.default.createBrotliDecompress(options.brotli);
            }
            break;
        case "identity":
            return stream;
