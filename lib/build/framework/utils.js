...
function inflate(stream, options) {
    ...
    switch (encoding) {
        ...
        case "deflate":
            ...
            decompression = node_zlib_1.default.createUnzip(options);
            break;
        case "br":
            if (node_zlib_1.default.createBrotliDecompress) {
                decompression = node_zlib_1.default.createBrotliDecompress(options.brotli);
            }
            break;
        case "identity":
            return stream;
