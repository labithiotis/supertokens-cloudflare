...
var emaildelivery_exports = {};
__export(emaildelivery_exports, {
  default: () => EmailDelivery
});
module.exports = __toCommonJS(emaildelivery_exports);
var import_supertokens_js_override = __toESM(require("supertokens-js-override"), 1);
class EmailDelivery {
  constructor(config) {
    let builder = new import_supertokens_js_override.default(config.service);
