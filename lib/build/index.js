...
export default class SuperTokensWrapper {
    ...
    static getUsersOldestFirst(input) {
        return AccountLinking.getInstance().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "ASC" }, input), { userContext: getUserContext(input.userContext) }));
    }
    static getUsersNewestFirst(input) {
        return AccountLinking.getInstance().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "DESC" }, input), { userContext: getUserContext(input.userContext) }));
    }
    static createUserIdMapping(input) {
        return SuperTokens.getInstanceOrThrowError().createUserIdMapping(Object.assign(Object.assign({}, input), { userContext: getUserContext(input.userContext) }));
    }
    static getUserIdMapping(input) {
        return SuperTokens.getInstanceOrThrowError().getUserIdMapping(Object.assign(Object.assign({}, input), { userContext: getUserContext(input.userContext) }));
    }
    static deleteUserIdMapping(input) {
        return SuperTokens.getInstanceOrThrowError().deleteUserIdMapping(Object.assign(Object.assign({}, input), { userContext: getUserContext(input.userContext) }));
    }
    static updateOrDeleteUserIdMappingInfo(input) {
        return SuperTokens.getInstanceOrThrowError().updateOrDeleteUserIdMappingInfo(Object.assign(Object.assign({}, input), { userContext: getUserContext(input.userContext) }));
    }
