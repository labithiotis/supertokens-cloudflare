...
export function validateAndNormaliseUserInput(_, appInfo, config) {
...
export function defaultValidatePhoneNumber(value) {
...
export function defaultValidateEmail(value) {
...
export function getEnabledPwlessFactors(config) {
    let allFactors;
