...
var passwordlessLogin_exports = {};
__export(passwordlessLogin_exports, {
  default: () => getPasswordlessLoginEmailContent,
  getPasswordlessLoginEmailHTML: () => getPasswordlessLoginEmailHTML
});
module.exports = __toCommonJS(passwordlessLogin_exports);
...
function getPasswordlessLoginEmailHTML(appName, email, codeLifetime, urlWithLinkCode, userInputCode) {
  if (urlWithLinkCode !== void 0 && userInputCode !== void 0) {
    return getPasswordlessLoginOTPAndURLLinkBody(
      appName,
      email,
      (0, import_utils.humaniseMilliseconds)(codeLifetime),
      urlWithLinkCode,
      userInputCode
    );
  }
  if (userInputCode !== void 0) {
    return getPasswordlessLoginOTPBody(appName, email, (0, import_utils.humaniseMilliseconds)(codeLifetime), userInputCode);
  }
  if (urlWithLinkCode !== void 0) {
    return getPasswordlessLoginURLLinkBody(appName, email, (0, import_utils.humaniseMilliseconds)(codeLifetime), urlWithLinkCode);
  }
