...
export function getPasswordlessLoginEmailHTML(appName, email, codeLifetime, urlWithLinkCode, userInputCode) {
    if (urlWithLinkCode !== undefined && userInputCode !== undefined) {
        return getPasswordlessLoginOTPAndURLLinkBody(appName, email, humaniseMilliseconds(codeLifetime), urlWithLinkCode, userInputCode);
    }
