...
export default async function consumeCode(apiImplementation, tenantId, options, userContext) {
    ...
    if (result.status === "OK") {
        result = Object.assign(Object.assign({}, result), getBackwardsCompatibleUserInfo(options.req, result, userContext));
