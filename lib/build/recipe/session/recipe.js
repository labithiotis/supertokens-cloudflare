...
import { clearSessionFromAllTokenTransferMethods, getCORSAllowedHeaders as getCORSAllowedHeadersFromCookiesAndHeaders, } from "./cookieAndHeaders";
...
export default class SessionRecipe extends RecipeModule {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.isErrorFromThisRecipe = (err) => {
            return (STError.isErrorFromSuperTokens(err) &&
        ...
        let builder = new OverrideableBuilder(RecipeImplementation(Querier.getNewInstanceOrThrowError(recipeId), this.config, this.getAppInfo(), () => this.recipeInterfaceImpl));
