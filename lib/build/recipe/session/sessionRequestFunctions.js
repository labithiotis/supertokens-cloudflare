...
async function getSessionFromRequest({ req, res, config, recipeInterfaceImpl, options, userContext, }) {
    ...
    for (const transferMethod of constants_1.availableTokenTransferMethods) {
        const tokenString = (0, cookieAndHeaders_1.getToken)(req, "access", transferMethod);
    ...
    if ((allowedTransferMethod === "any" || allowedTransferMethod === "header") &&
        ...
        const hasMultipleAccessTokenCookies = (0, cookieAndHeaders_1.hasMultipleCookiesForTokenType)(req, "access");
...
async function refreshSessionInRequest({ res, req, userContext, config, recipeInterfaceImpl, }) {
    ...
    for (const transferMethod of constants_1.availableTokenTransferMethods) {
        refreshTokens[transferMethod] = (0, cookieAndHeaders_1.getToken)(req, "refresh", transferMethod);
    ...
    if ((allowedTransferMethod === "any" || allowedTransferMethod === "header") &&
        ...
        if ((allowedTransferMethod === "any" || allowedTransferMethod === "cookie") &&
            (0, cookieAndHeaders_1.getToken)(req, "access", "cookie") !== undefined) {
...
async function createNewSessionInRequest({ req, res, userContext, recipeInstance, accessTokenPayload, userId, recipeUserId, config, appInfo, sessionDataInDatabase, tenantId, }) {
    ...
    for (const transferMethod of constants_1.availableTokenTransferMethods) {
        if (transferMethod !== outputTransferMethod && (0, cookieAndHeaders_1.getToken)(req, "access", transferMethod) !== undefined) {
            (0, cookieAndHeaders_1.clearSession)(config, res, transferMethod, req, userContext);
        }
    }
