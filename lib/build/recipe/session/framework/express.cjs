...
var import_framework = require("../../../framework/express/framework");
var import_supertokens = __toESM(require("../../../supertokens"), 1);
var import_utils = require("../../../utils");
function verifySession(options) {
  return async (req, res, next) => {
    const request = new import_framework.ExpressRequest(req);
    const response = new import_framework.ExpressResponse(res);
