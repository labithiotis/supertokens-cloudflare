...
export function parseJWTWithoutSignatureVerification(jwt) {
    ...
    if (!HEADERS.has(splittedInput[0])) {
        ...
        if (parsedHeader.version !== undefined) {
            ...
            logDebugMessage("parseJWTWithoutSignatureVerification: assuming latest version (3) because version header is missing");
