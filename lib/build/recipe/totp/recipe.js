...
import { CREATE_TOTP_DEVICE, VERIFY_TOTP_DEVICE, VERIFY_TOTP, LIST_TOTP_DEVICES, REMOVE_TOTP_DEVICE, } from "./constants";
...
export default class Recipe extends RecipeModule {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        {
            let builder = new OverrideableBuilder(RecipeImplementation(Querier.getNewInstanceOrThrowError(recipeId), this.config));
