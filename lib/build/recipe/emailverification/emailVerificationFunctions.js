...
export async function createAndSendEmailUsingSupertokensService(appInfo, user, emailVerifyURLWithToken) {
    if (env.TEST_MODE === "testing") {
        return;
    }
    await postWithFetch("https://api.supertokens.io/0/st/auth/email/verify", {
        "api-version": "0",
