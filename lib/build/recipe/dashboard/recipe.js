...
import { DASHBOARD_ANALYTICS_API, DASHBOARD_API, SEARCH_TAGS_API, SIGN_IN_API, SIGN_OUT_API, USERS_COUNT_API, USERS_LIST_GET_API, USER_API, USER_EMAIL_VERIFY_API, USER_EMAIL_VERIFY_TOKEN_API, USER_METADATA_API, USER_PASSWORD_API, USER_SESSIONS_API, VALIDATE_KEY_API, UNLINK_USER, USERROLES_LIST_API, USERROLES_ROLE_API, USERROLES_REMOVE_PERMISSIONS_API, USERROLES_PERMISSIONS_API, USERROLES_USER_API, CREATE_EMAIL_PASSWORD_USER, CREATE_PASSWORDLESS_USER, LIST_TENANTS_WITH_LOGIN_METHODS as LIST_ALL_TENANTS_WITH_LOGIN_METHODS, TENANT_API, UPDATE_TENANT_FIRST_FACTOR_API, UPDATE_TENANT_REQUIRED_SECONDARY_FACTOR_API, UPDATE_TENANT_CORE_CONFIG_API, TENANT_THIRD_PARTY_CONFIG_API, } from "./constants";
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(USERROLES_REMOVE_PERMISSIONS_API)),
                    disabled: false,
                    method: "put",
                },
                {
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(LIST_ALL_TENANTS_WITH_LOGIN_METHODS)),
                    disabled: false,
                    method: "get",
                },
                {
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(UPDATE_TENANT_FIRST_FACTOR_API)),
                    disabled: false,
                    method: "put",
                },
                {
                    id: UPDATE_TENANT_REQUIRED_SECONDARY_FACTOR_API,
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(UPDATE_TENANT_REQUIRED_SECONDARY_FACTOR_API)),
                    disabled: false,
                    method: "put",
                },
                {
                    id: UPDATE_TENANT_CORE_CONFIG_API,
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(UPDATE_TENANT_CORE_CONFIG_API)),
                    disabled: false,
                    method: "put",
                },
                {
                    id: TENANT_THIRD_PARTY_CONFIG_API,
                    pathWithoutApiBasePath: new NormalisedURLPath(getApiPathWithDashboardBase(TENANT_THIRD_PARTY_CONFIG_API)),
                    disabled: false,
                    method: "get",
                },
                {
