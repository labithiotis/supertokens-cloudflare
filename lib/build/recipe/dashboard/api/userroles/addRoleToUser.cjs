...
var addRoleToUser_exports = {};
__export(addRoleToUser_exports, {
  default: () => addRoleToUser_default
});
module.exports = __toCommonJS(addRoleToUser_exports);
...
const addRoleToUser = async (_, tenantId, options, __) => {
  ...
  const response = await import_userroles.default.addRoleToUser(tenantId, userId, role);
  return response;
};
