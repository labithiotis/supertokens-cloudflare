...
var deleteRole_exports = {};
__export(deleteRole_exports, {
  default: () => deleteRole_default
});
module.exports = __toCommonJS(deleteRole_exports);
...
const deleteRole = async (_, ___, options, __) => {
  ...
  const response = await import_userroles.default.deleteRole(role);
  return response;
};
