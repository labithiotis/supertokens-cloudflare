...
var getPermissionsForRole_exports = {};
__export(getPermissionsForRole_exports, {
  default: () => getPermissionsForRole_default
});
module.exports = __toCommonJS(getPermissionsForRole_exports);
...
const getPermissionsForRole = async (_, ___, options, __) => {
  ...
  const response = await import_userroles.default.getPermissionsForRole(role);
  return response;
};
