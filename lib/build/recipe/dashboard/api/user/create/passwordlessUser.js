...
export const createPasswordlessUser = async (_, tenantId, options, __) => {
    ...
    return await Passwordless.signInUp(email !== undefined ? { email, tenantId } : { phoneNumber: phoneNumber, tenantId });
};
