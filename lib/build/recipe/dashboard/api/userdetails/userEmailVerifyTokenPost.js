...
export const userEmailVerifyTokenPost = async (_, tenantId, options, userContext) => {
    ...
    return await EmailVerification.sendEmailVerificationEmail(tenantId, user.id, convertToRecipeUserId(recipeUserId), undefined, userContext);
};
