...
var userSessionsPost_exports = {};
__export(userSessionsPost_exports, {
  userSessionsPost: () => userSessionsPost
});
module.exports = __toCommonJS(userSessionsPost_exports);
...
const userSessionsPost = async (_, ___, options, userContext) => {
  ...
  await import_session.default.revokeMultipleSessions(sessionHandles, userContext);
  return {
    status: "OK"
  };
};
