...
var tagsGet_exports = {};
__export(tagsGet_exports, {
  getSearchTags: () => getSearchTags
});
module.exports = __toCommonJS(tagsGet_exports);
...
const getSearchTags = async (_, ___, options, userContext) => {
  ...
  let tagsResponse = await querier.sendGetRequest(new import_normalisedURLPath.default("/user/search/tags"), {}, userContext);
  return tagsResponse;
};
