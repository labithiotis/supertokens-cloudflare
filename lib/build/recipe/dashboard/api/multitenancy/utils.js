...
export function getNormalisedFirstFactorsBasedOnTenantConfigFromCoreAndSDKInit(tenantDetailsFromCore) {
    let firstFactors;
...
export function getNormalisedRequiredSecondaryFactorsBasedOnTenantConfigFromCoreAndSDKInit(tenantDetailsFromCore) {
...
export function factorIdToRecipe(factorId) {
...
export function getFactorNotAvailableMessage(factorId, availableFactors) {
