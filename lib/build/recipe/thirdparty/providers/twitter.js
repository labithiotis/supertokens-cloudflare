...
import NewProvider, { DEV_OAUTH_REDIRECT_URL, getActualClientIdFromDevelopmentClientId, isUsingDevelopmentClientId, } from "./custom";
import { doPostRequest } from "./utils";
import { Buffer } from "node:buffer";
export default function Twitter(input) {
    var _a;
    ...
    input.override = function (originalImplementation) {
        ...
        originalImplementation.exchangeAuthCodeForOAuthTokens = async function (input) {
            ...
            const tokenResponse = await doPostRequest(originalImplementation.config.tokenEndpoint, twitterOauthTokenParams, {
