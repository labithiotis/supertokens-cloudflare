...
function NewProvider(input) {
    ...
    let impl = {
        ...
        exchangeAuthCodeForOAuthTokens: async function ({ redirectURIInfo }) {
            ...
            /* Transformation needed for dev keys END */
            const tokenResponse = await (0, utils_1.doPostRequest)(tokenAPIURL, accessTokenAPIParams);
        ...
        getUserInfo: async function ({ oAuthTokens, userContext }) {
            ...
            if (idToken && impl.config.jwksURI !== undefined) {
                ...
                rawUserInfoFromProvider.fromIdTokenPayload = await (0, utils_1.verifyIdTokenFromJWKSEndpointAndGetPayload)(idToken, jwks, {
            ...
            if (accessToken && impl.config.userInfoEndpoint !== undefined) {
                ...
                const userInfoFromAccessToken = await (0, utils_1.doGetRequest)(impl.config.userInfoEndpoint, queryParams, headers);
