...
const isValidFirstFactor = async function (tenantId, factorId, userContext) {
    ...
    (0, logger_1.logDebugMessage)(`isValidFirstFactor tenantconfig enables: ${Object.keys(tenantConfig).filter((k) => { var _a; return (_a = tenantConfig[k]) === null || _a === void 0 ? void 0 : _a.enabled; })}`);
