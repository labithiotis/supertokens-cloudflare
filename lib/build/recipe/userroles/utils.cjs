...
function validateAndNormaliseUserInput(_, __, config) {
  ...
  return {
    skipAddingRolesToAccessToken: (config == null ? void 0 : config.skipAddingRolesToAccessToken) === true,
    skipAddingPermissionsToAccessToken: (config == null ? void 0 : config.skipAddingPermissionsToAccessToken) === true,
    override
  };
}
