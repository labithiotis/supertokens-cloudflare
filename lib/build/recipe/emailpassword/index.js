...
export default class Wrapper {
    ...
    static updateEmailOrPassword(input) {
        return Recipe.getInstanceOrThrowError().recipeInterfaceImpl.updateEmailOrPassword(Object.assign(Object.assign({}, input), { userContext: getUserContext(input.userContext), tenantIdForPasswordPolicy: input.tenantIdForPasswordPolicy === undefined ? DEFAULT_TENANT_ID : input.tenantIdForPasswordPolicy }));
    }
    ...
    static async sendEmail(input) {
        ...
        return await recipeInstance.emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign(Object.assign({}, input), { tenantId: input.tenantId === undefined ? DEFAULT_TENANT_ID : input.tenantId, userContext: getUserContext(input.userContext) }));
    }
}
