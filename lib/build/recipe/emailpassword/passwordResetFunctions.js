...
export async function createAndSendEmailUsingSupertokensService(appInfo, user, passwordResetURLWithToken) {
    // related issue: https://github.com/supertokens/supertokens-node/issues/38
    if (env.TEST_MODE === "testing") {
        return;
    }
    await postWithFetch("https://api.supertokens.io/0/st/auth/password/reset", {
        "api-version": "0",
