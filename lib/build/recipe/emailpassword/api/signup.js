...
export default async function signUpAPI(apiImplementation, tenantId, options, userContext) {
    ...
    // step 1
    let formFields = await validateFormFieldsOrThrowError(options.config.signUpFeature.formFields, requestBody.formFields, tenantId, userContext);
