...
function getAPIImplementation() {
    return {
        ...
        passwordResetPOST: async function ({ formFields, token, tenantId, options, userContext, }) {
            ...
            let existingUser = await (0, __1.getUser)(tokenConsumptionResponse.userId, userContext);
        ...
        signUpPOST: async function ({ formFields, tenantId, session, options, userContext, }) {
            ...
            if (postAuthChecks.status !== "OK") {
                return authUtils_1.AuthUtils.getErrorStatusResponseWithReason(postAuthChecks, errorCodeMap, "SIGN_UP_NOT_ALLOWED");
            }
            return {
                status: "OK",
                session: postAuthChecks.session,
