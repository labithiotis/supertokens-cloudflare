...
export function normaliseSignUpFormFields(formFields) {
...
export async function defaultPasswordValidator(value) {
    // length >= 8 && < 100
...
export async function defaultEmailValidator(value) {
